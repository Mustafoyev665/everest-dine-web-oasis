      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div className="glass-card p-8 animate-fade-in">
            <h2 className="text-3xl font-display font-bold mb-6">The Everest Experience</h2>
          ...
          <div className="glass-card overflow-hidden animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="bg-gradient-to-br from-yellow-400/20 to-amber-700/20 aspect-square w-full flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <h3 className="text-xl font-semibold mb-2">Chef's Portrait</h3>
                <p className="text-gray-400">Chef Michael Chang</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card p-12 text-center animate-fade-in">
          <h2 className="text-3xl font-display font-bold mb-6">Experience the Everest Difference</h2>
